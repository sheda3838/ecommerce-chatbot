    ...
    <div className="relative w-full h-screen bg-white flex flex-col md:flex-row overflow-hidden font-sans">
      ...
      <div className="w-full md:w-1/2 h-[60vh] md:h-full flex flex-col justify-center p-8 sm:p-12 md:p-16 lg:p-24 relative z-10 pt-24 md:pt-0">
        ...
        >
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-blue-600 tracking-tighter leading-[1.1] mb-6">
            Elevate Your <br />
            Everyday.
          </h1>
          ...
          <Link to="/shop">
            <motion.button 
              ...
              whileTap={{ scale: 0.95 }}
              className="group bg-blue-600 text-white px-8 py-4 rounded-none font-bold tracking-wider uppercase text-sm flex items-center gap-3 w-fit hover:bg-blue-700 transition-colors shadow-xl"
            >
              Explore Collection
          ...
          <div className="mt-16 flex items-center gap-6">
            ...
            <div>
              ...
              <p className="text-xs font-bold text-blue-600 mt-1">Loved by 10,000+ customers</p>
            </div>
          </div>
        </motion.div>
      </div>
