...
const FloatingCart = ({ onClick }) => {
  ...
  return (
    <motion.button 
      ...
      whileTap={{ scale: 0.9 }}
      className="fixed top-8 right-8 z-50 bg-white/80 backdrop-blur-lg border border-white p-4 rounded-full shadow-2xl hover:bg-white transition-colors cursor-pointer"
    >
